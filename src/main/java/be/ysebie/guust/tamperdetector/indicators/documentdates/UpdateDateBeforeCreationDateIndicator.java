...
public class UpdateDateBeforeCreationDateIndicator extends CreationAndModificationDateIndicator {

    @Override
    public Result analyze() {
        if (getCreationDateCalendar().before(getModificationDateCalendar())) {
            return new Result(this, AnalysisResult.NO_TAMPERING);
        }
        return new MessageResult(this, AnalysisResult.TAMPERING_DETECTED,
                "ModificationDate is before CreationDate");
    }
}
