...
public class DifferentFontSizeInLineIndicatorTest {


    @Test
    public void test001() throws IOException {
        DifferentFontSizeInLineIndicator indicator = new DifferentFontSizeInLineIndicator();
        ...
        paragraph.add(new Text("Text three").setFontSize(15));
